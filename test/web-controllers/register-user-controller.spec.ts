...
describe('Register user web controller', () => {
  ...
  const sendEmailUserCase: SendEmail = new SendEmail(mailOptions, mailServiceStub)
  const registerAndSendEmailUseCase: RegisterAndSendEmail =
    new RegisterAndSendEmail(registerUseCase, sendEmailUserCase)
  ...
  test('Should return status code ok (200) when request contains valid user data', async () => {
